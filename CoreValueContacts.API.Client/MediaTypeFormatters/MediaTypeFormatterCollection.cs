...
namespace CoreValueContacts.API.Client.MediaTypeFormatters
{
    internal sealed class MediaTypeFormatterCollection : ReadOnlyCollection<MediaTypeFormatter>
    {
        ...
        private MediaTypeFormatterCollection() : base(new List<MediaTypeFormatter> { new JsonMediaTypeFormatter()})
        {
